    ...
    return (
        <div>
            <div className="more-div" style={{ marginTop: "-359px"}}>
                ...
                <a href="#"><div className="more-text-1">관련법</div></a>

                <a href="#"><div className="more-text-2">지속가능발전기본법</div></a>
                <a href="#"><div className="more-text-2">시행령</div></a>
                <a href="#"><div className="more-text-2">경기도 조례</div></a>
                <a href="#"><div className="more-text-2">파주시 조례</div></a>

                <a href="#"><div className="more-point" /><div className="more-text">파주시지속가능발전협의회</div></a>
                <a href="#"><div className="more-text-1">연혁</div></a>
                ...
                <a href="#"><div className="more-text-2">경기도지속가능발전협의회</div></a>

                <a href="#"><div className="more-text-1">파주시 거버너스</div></a>
                <a href="#"><div className="more-text-2">파주시청</div></a>
                <a href="#"><div className="more-text-2">파주시의회</div></a>
                <a href="#"><div className="more-text-2">시민사회단체</div></a>
