                ...
                <div className="main-1">
                    ...
                    <div className="news">
                        ...
                        <div className="news-head"onClick={go1}>전체</div>
                            <div className="news-head"  onClick={go2}>공지</div>
                            <div className="news-head" onClick={go3}>뉴스</div>
                            <div className="news-head" style={{fontWeight: "bold"}}  onClick={go4}>커뮤니티</div>
                        </div>
                        <div className="post">
                            <a href="#">1번 커뮤니티 게시물입니다.</a>
                            <a href="#">2번 커뮤니티 게시물입니다.</a>
                            <a href="#">3번 커뮤니티 게시물입니다.</a>
                            <a href="#">4번 커뮤니티 게시물입니다.</a>
                            <a href="#">5번 커뮤니티 게시물입니다.</a>
                        </div>
